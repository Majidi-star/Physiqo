...
### 📸 Media & Demos
<p align="center">
  <img src="assets/images/app_demo.gif" alt="Physiqo Core App Demo" width="300"/>
  &nbsp;&nbsp;&nbsp;&nbsp;
  <img src="assets/images/ai_setup.gif" alt="Physiqo AI Connection Setup Guide" width="300"/>
  <br/>
...
### ⚡ মূল বৈশিষ্ট্যসমূহ
১. **সিনেমাটিক ডার্ক ডিজাইন:** কোনো অতিরিক্ত শ্যাডো বা গ্লো ছাড়াই প্রিমিয়াম ডার্ক থিম (ব্যাকগ্রাউন্ড `#1C1C1E`, প্রাইমারী `#FF6B2C`) ব্যবহার করা হয়েছে।
২. **১০০% সার্ভারহীন ও নিরাপদ:** আপনার এআই এপিআই কীগুলি সম্পূর্ণ অফলাইনে লোকাল স্টোরেজে সুরক্ষিতভাবে এনক্রিপ্ট করে রাখা হয়।
৩. **বহুভাষিক ও অটো-আরটিএল:** সঠিক লেআউট ডিরেকশন ও অ্যালাইনমেন্ট সহ ১১টি ভাষায় তাৎক্ষণিক রূপান্তর সুবিধা।
৪. **শারীরিক ভারসাম্য বিশ্লেষণ:** বডি স্ক্যান ও ছবি বিশ্লেষণের মাধ্যমে শরীরের ভারসাম্যহীনতা এবং দুর্বল পেশী সনাক্তকরণ।
৫. **আঘাত প্রোফাইল কাস্টমাইজেশন:** আপনার আঘাতপ্রাপ্ত জয়েন্ট বা পেশীর ওপর অতিরিক্ত চাপ এড়াতে ব্যায়াম পরিবর্তন করা হয়।
